...
module.exports.current_BodyMeasurement = async (req, res) => {
  try {
    ...
    let optionArr = [{
        answerKey: bmi_heightwieght[0].length != "" ?
          bmi_heightwieght[0].value.trim() :
          "", //weight.length > 0 ? parseFloat(weight[0].options) : 0,
        answerKey_weight: bmi_heightwieght[0].length != "" ? bmi_heightwieght[0].weight_to : "", //weight.length > 0 ? parseFloat(weight[0].options) : 0,
      ...
      {
        answerKey: userDetail.length > 0 && userDetail[0].age != null ?
          userDetail[0].age :
          0,
        healthQuestions_Id: 0,
        keyName: "age",
      ...
      {
        answerKey: userDetail.length > 0 && userDetail[0].gender != null ?
          userDetail[0].gender :
          "",
        healthQuestions_Id: 0,
        keyName: "gender",
  ...
  try {
    ...
    let obj = [{
        ...
        answer1: [{
          ...
          {
            ansKey: "other associated complaints like bloating, fatigue and tiredness;",
          },
          {
        ...
        answer2: [{
          ...
          {
            ansKey: "2.Meet at least 50% of your bi-weekly goals in order to unlock new weeks.",
          },
          {
            ansKey: "3.You can renew previous goals for 2 more weeks but 50% compliance is required to move forward.",
          },
          {
            ansKey: "4.Once you unlock more weeks, choose new goals & set reminders again.",
          },
          {
            ansKey: "5.Track your goals via food logs & activity logs."
          },
          {
            ansKey: "6.Upload pics of your food plates so that the habit graph can depict your performance.",
          },
          {
            ansKey: "7.Choose from a list of activities which have the calorie burn estimate/hour. Set daily reminders for your selected time slot.",
          },
          {
        ...
        content2: "A graph of your compliance with daily goals, based on your inputs, will help you track your progress.",
        ...
        AvoidPro: [{
          ...
          {
            point: "1.High-sugar foods causing immunosuppression for 2-4 hrs after eating",
          },
          {
      ...
      },
      {
        ...
        answer1: [{
          ...
          {
            ansKey: "•	are pre-diabetic or have had two or more episodes of high blood glucose consecutively;",
          },
          {
            ansKey: "•	have abdominal obesity and high cholesterol levels; and/or",
          },
          {
            ansKey: "•	have a sweet tooth and would like to just develop a disciplined lifestyle",
          },
        ],
        question2: "How do I follow this program?",
        answer2: [{
        ...
        title5: "Recommendations",
        AvoidPro: [{
          title: "Did you know: in diabetes meal planning,one serving of a food with carbohydrates has about 15 grams of carbohydrates.",
        }, ],
        Dos: [{
            point: "•	Check serving sizes with measuring cups and spoons."
          },
          {
            point: "•	Read the Nutrition Facts on food labels to find out how many grams of carbohydrates are in the foods you eat.",
          },
          {
            point: "•	Count one cup of raw vegetables or 1⁄2 cup of cooked, non-starchy vegetables as zero carbohydrate servings or “free” foods. If you consume three or more servings for one meal, then count them as one carbohydrate serving.",
          },
          {
            point: "•	Foods that have less than 20 calories in each serving also may be counted as zero carbohydrate servings or “free” foods.",
          },
          {
            point: "•	Count one cup of casserole or other mixed foods as two carbohydrate servings.",
          },
        ],
        Donots: [{
            point: "•	Remove all sweet, white and processed food items from your diet.",
          },
          {
            point: "•	Reduce the use of medications by eating at regular meal times daily.",
          },
          {
            point: "•	Psychology: don’t focus on sugar reduction but on adding more flavors and taste adventures.",
          },
        ],
      },
      {
        ...
        question1: "What is Energy Booster program? Is it right for me?",
        answer1: [{
            ansKey: "This program focuses on boosting energy and improving metabolism through the use of therapeutic foods. It’s suitable for you if you:",
          },
          {
        ...
        AvoidPro: [{
          ...
          {
            point: "•	Foods: Complex carbs, healthy fats and proteins (oatmeal, eggs, beans, chicken, sardines, walnuts, etc.)",
          },
          {
        ...
        AddAnti: [{
          ...
          {
            point: "•	Foods: Fried/fast food, fizzy drinks, pasta, white bread, rice, etc.",
          },
          {
      ...
      },
      {
        ...
        answer1: [{
            ansKey: "This program is focused on reducing the risk of developing heart diseases by addressing modifiable risk factors such as high cholesterol and elevated blood fats, high blood glucose, high blood pressure, increased belly fat, etc.",
          },
          {
            ansKey: "This program is for you if want to fight metabolic diseases by:",
          },
          {
        ...
        AvoidPro: [{
          ...
          {
            point: "5. watching intake of risky diet elements like alcohol, saturated fats and so on;",
          },
          {
        ...
        AddAnti: [{
          ...
          {
            point: "Please visit our meal plan/recipe section to find Mediterranean Diet OR calorie based, heart healthy recipes.",
          },
        ],
      },
      {
        ...
        answer1: [{
            ansKey: "As one of the foundations of good health, sleep must be of good quality in order to provide rejuvenation to the body and mind. It can be challenging to carry on with your daily routine if you have chronic sleep problems. This program is right for you if you often:",
          },
          {
        ...
        AvoidPro: [{
          ...
          {
            point: "The melatonin hormone tells your body it’s time to sleep. Some foods high in melatonin are:",
          },
          {
            point: "•	Almonds"
          },
      ...
      },
      {
        ...
        answer1: [{
            ansKey: "Stress is an integral part of life. However, prolonged stress can be detrimental to your health and quality of life.",
          },
          {
          ...
          {
            ansKey: "•	frequently experience heavy breathing, palpitations, sweating or faintness;",
          },
          {
            ansKey: "•	have lost interest in your work, hobbies and other activities",
          },
        ],
        question2: "How do I follow this program?",
        answer2: [{
...
async function challengeTaskGoal(
  Challenge,
  user_Id,
  company_Id,
  challengeUserAssignDetail
  ...
  console.log(
    goalChallengeArr.length + " " + valueCondition + " " + valueTimes,
    "condition of challenge"
  );
  if (difference >= valueTimes) {
    if (
      eval(goalChallengeArr.length + " " + valueCondition + " " + valueTimes)
    ) {
