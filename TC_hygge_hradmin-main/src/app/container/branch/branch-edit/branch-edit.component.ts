...
'Others']}
  ...
  userList:any[] = [];
  accessData:any;
  constructor(@Inject(MAT_DIALOG_DATA) public data: DialogData,public _alert:AlertService, public _api: CommonServiceService, public ngxService: NgxUiLoaderService, public _snackBar: MatSnackBar, public dialogRef: MatDialogRef<BranchEditComponent>) {
  ...
  ngOnInit(): void {
    ...
    this.formData.branch_Id = this.accessData.branch_id
    this.formData.company_Contact = this.accessData.company_Contact;
    this.formData.corporate_email = this.accessData.corporate_Email;
    this.formData.company_YearEstablished = this.accessData.company_YearEstablished;
    this.formData.company_Address = this.accessData.company_Address;
    this.formData.access = JSON.parse(this.accessData.access);
    this.formData.company_BusinessType =this.accessData.company_BusinessType;
    this.formData.company_WorkingHours =this.accessData.company_WorkingHours;
    this.formData.company_Industry =this.accessData.company_Industry;
    this.formData.P_firstName =this.accessData.P_firstName;
    this.formData.P_lastName =this.accessData.P_lastName;
    this.formData.branch_Name =this.accessData.branch_Name;
    this.formData.PC_Email =this.accessData.PC_Email;
    this.formData.P_Contact =this.accessData.P_Contact;
    this.formData.PC_Designation =this.accessData.PC_Designation;
    this.formData.salary_TemplateID =this.accessData.salary_TemplateID;
    let addressData = this.accessData.company_Address.split(',');
    this.addressData = {
      building_name:addressData[0],
      street:addressData[1],
      office_number:addressData[2],
      po_box:addressData[3],
      emirates:addressData[4],
      city:addressData[5]
    }
    this.getList();
  }
 ...
 async getList(){
  ...
  async editBranch(){
    ...
    this.ngxService.start();
    await(this._api.updateBranch(this.formData).subscribe(res => {
      this.ngxService.stop();
      const response: any = res;
      if (response.success == true){
