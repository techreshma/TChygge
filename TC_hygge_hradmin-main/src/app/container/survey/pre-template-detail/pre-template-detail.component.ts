...
@Component({
  selector: 'app-pre-template-detail',
  templateUrl: './pre-template-detail.component.html',
  styleUrls: ['./pre-template-detail.component.scss']
})
export class PreTemplateDetailComponent implements OnInit {
  id:any;
  question:any = [];
  surveyName:any;
...
async openSurveyQuestion(){
  ...
  await(this._api.getTemplateQuestions(formData).subscribe(res => {
    ...
    if (response.success == true){
      ...
      this.surveyName =  response.templateName;
