...
export class EditSurveyComponent implements OnInit {
  ...
  question: any = [
    {
      ...
      "survey_Title": "", //
      "survey_Description": "", //
      "survey_OptionArray": [{ "value": "", "point": "" }], //
      "survey_SubQuestion": [], //
  ...
  async addHra() {
    ...
    if (this.formName == '' || this.formDescription == '' || q.survey_Type == '' || q.survey_Title == '' || q.survey_Description == '' || q.survey_OptionArray.length !== qCount) {
