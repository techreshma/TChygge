...
export class LoginComponent implements OnInit {
  ...
  accessModule:any;
  constructor(public _access:AccessServiceService,public _auth: AuthServiceService, private ngxService: NgxUiLoaderService, private _snackBar: MatSnackBar, public router:Router) {
